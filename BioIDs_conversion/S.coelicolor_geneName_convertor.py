# Query the table generated before, look for the relationship between the geneID listed in input,
# give a output list suitable for online geneontology (actually protein) annotation / enrichment
