# developed to incoperate SNPs got from RNASeq project into the protein database
# which can be later used in the shoot gun proteomics protein identificaiton,
# presumably increase the coverage of protein identificaiton
