...
# For CRISPR spacer checking:
# A find a spacer in target region, and I will do blast on the genome.
# Result will be opend for you to check the specificity of your spacer.
...
output_file = os.path.join(
    workPath, "Resources/Strains and Plasmids/Streptomyces_albus/temp/seq_sp_blast.out")
temp_file = os.path.join(
    workPath, "Resources/Strains and Plasmids/Streptomyces_albus/temp/seq_sp.fa")
